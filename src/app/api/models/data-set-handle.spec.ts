...
describe('DataSetHandle', () => {
  let jsonDataSetHandle;
  let dataSetHandle: DataSetHandle;
  beforeEach(() => {
    jsonDataSetHandle = {
      "dsOrdersByInternalIdFlat": {
        "eOrder": [
          {
            "RecId_": 2496,
            "RowId_": "AAAAAAAACcA=",
    ...
    dataSetHandle = new DataSetHandle().deserialize(jsonDataSetHandle);
  });
  it('should create an instance', () => {
    expect(new DataSetHandle()).toBeTruthy();
  });
  it('deserializes a DataSetHandle json object to a DataSetHandle object', () => {
    expect(dataSetHandle instanceof DataSetHandle).toBeTruthy();
    expect(dataSetHandle.flatDataSetHandle instanceof DsOrdersByInternalIdFlat).toBeTruthy();
    expect(dataSetHandle.flatDataSetHandle).not.toBeNull();
  });
});
