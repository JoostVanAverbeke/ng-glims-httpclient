...
describe('FlatDataSetHandleFactory', () => {
  ...
  beforeEach(() => {
    ...
    dsOrdersByInternalIdFlat = FlatDataSetHandleFactory.createInstance(jsonDataSetHandle);
  });
  it('should create an instance', () => {
    expect(new FlatDataSetHandleFactory()).toBeTruthy();
  });
  it('creates an flat data set handle instance from a json DataSetHandle object', () => {
